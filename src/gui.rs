...
use specs::prelude::*;
use super::{Player, CombatStats, gamelog::GameLog, Map, Name, Position, State, InBackpack, Viewshed, Equipped, HungerClock, 
    HungerState, Hidden, camera};
...
pub fn draw_ui(ecs: &World, ctx : &mut Rltk) {
    ...
    for (_player, stats, hc) in (&players, &combat_stats, &hunger).join() {
        ...
        ctx.draw_bar_horizontal(28, 43, 48, stats.hp, stats.max_hp, RGB::named(rltk::RED), RGB::named(rltk::BLACK));
